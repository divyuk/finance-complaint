...
class DataTransformation():
    ...
    def get_data_transformation_pipeline(self, ) -> Pipeline:
        # arrange transformation in steps and sequence 
        try:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            train_dataframe, test_dataframe = dataframe.randomSplit([1 - test_size, test_size]) # train test split in spark is done through random Split.
            ...
            # Since Spark works In RDD, It always create a new dataframe it does not change the exisiting dataframe, IMMutable
